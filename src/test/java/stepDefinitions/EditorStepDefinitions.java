...
public class EditorStepDefinitions {
    ...
    public void first_name_kutusuna_yazar(String userName) {
        editorPage.firstName.sendKeys(userName);
    ...
    public void extension_kutusuna_yazar(String extention) {
        editorPage.extension.sendKeys(extention);
    }
    ...
    public void kullanici_ile_arama_yapar(String firstName) {
        editorPage.searhKutusu.sendKeys(firstName+ Keys.ENTER);
    }
